# Core Link Design Bible

This directory is the project-owned source for Core Link lore, systems, watch
UX, and future game relationship notes.

Start here:

- `lore-product-brief.md` - top-level product/lore brief
...
copy, UI, onboarding, contracts, or companion behavior.
